...
public class BlastTestCases {
    ...
    public void navigateToBlast() throws InterruptedException {
         ...
         WebElement getGrowElement = getGrwoElementwait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"navigation\"]/ul[1]/li[2]/a")));
         ...
         WebElement getBlastsWebElement = getBlastsWebElementWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"navigation\"]/ul[1]/li[2]/div[2]/div/div[1]/a")));
         ...
         WebElement sendNewBlastButton = sendNewBlastButtonWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"data-source\"]/div[1]/div/div[1]/button")));
         ...
         WebElement emailTypeBlast = waitforEmailTypeButton.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"blast-modal\"]/div/div/div/div[2]/div/div/div[1]/div/div[1]/a")));
    ...
    public void createSMSBlast() throws InterruptedException {
    	Thread.sleep(1000);
    	WebElement smsBlastButton = driver.findElement(By.xpath("//*[@id=\"blast-modal\"]/div/div/div/div[2]/div/div/div[1]/div/div[2]/div"));
    ...
    public void selectRecipients() {
        ...
        pageLoadCompleteWait.until((ExpectedCondition<Boolean>) wd -> ((org.openqa.selenium.JavascriptExecutor) wd).executeScript("return document.readyState").equals("complete"));
        driver.findElement(By.xpath("//*[@id=\"topnav\"]/div/ul[2]/li/button")).click();
    }
    ...
    public void validateBlast() throws InterruptedException {
        Thread.sleep(2000);
        WebElement blastStatus = driver.findElement(By.xpath("/html/body/div[4]/section[2]/div/div/div/div/div[1]/div/div[2]/span"));
        System.out.println("Status : " + blastStatus.getText());

        WebElement blastReason;
        String blastReasonText = "";
        try {
            blastReason = driver.findElement(By.xpath("/html/body/div[4]/section[2]/div/div/div/div/div[1]/div/div[2]/i/span"));
    ...
    public void sendBlast() {
        WebElement sendBlastButton = driver.findElement(By.xpath("/html/body/div[4]/div[2]/div[1]/div/div[2]/div/ul/li[1]/a/button"));
