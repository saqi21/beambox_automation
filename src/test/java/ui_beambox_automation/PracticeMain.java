	...
	public static void suggestionDropDown(WebDriver driver) throws InterruptedException {
		try {
			...
			WebElement fromElement = driver.findElement(
					By.xpath("//*[@id=\"top-banner\"]/div[2]/div/div/div/div[2]/div[1]/div[1]/label/span"));
			fromElement.click();

			Thread.sleep(2000);
			WebElement fromInputTag = driver.findElement(By
					.xpath("//*[@id=\"top-banner\"]/div[2]/div/div/div/div[2]/div[1]/div[1]/div[1]/div/div/div/input"));
			Thread.sleep(2000);
