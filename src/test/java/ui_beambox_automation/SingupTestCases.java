...
public class SingupTestCases {
	...
	public void singupPostiveTesting() {
		...
		driver.findElement(By.id("login_user_logins_attributes_0_user_attributes_businessname"))
				.sendKeys("Devsloop automate");
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/form/span[2]/div/div/div[2]/span/input"))
				.sendKeys("4000007020000003");
