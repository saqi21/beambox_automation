...
public class AddGuest {
	...
	public void addGuest() {
        ...
        while (retries < maxRetries) {
            try {
                WebElement guestsNavTag = driver.findElement(By.xpath("//*[@id=\"navigation\"]/ul[1]/li[1]/div[2]/div[1]/div[1]/a"));
                System.out.println(guestsNavTag.getAttribute("href"));

                // render to Guests Page
                driver.get(guestsNavTag.getAttribute("href"));

                WebElement addNewGuestButton = driver.findElement(By.xpath("//*[@id=\"data-source\"]/div[1]/div[1]/div/div/div/button"));
                System.out.println(addNewGuestButton.getText());
                addNewGuestButton.click();

                WebElement addGuest = driver.findElement(By.xpath("//*[@id=\"data-source\"]/div[1]/div[1]/div/div/div/ul/li[2]/a"));
                ...
                WebElement addGuestSubmitButton = driver.findElement(By.xpath("//*[@id=\"new-human\"]/div/div/div[3]/div/div[2]/div/button"));
