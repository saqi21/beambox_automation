...
public class BenefitsPages {
	...
	public void smartMarkitingCampainPage() {
		...
		WebElement smartMarktingLink = waitForSmartMarktingLink.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//*[@id=\"nav\"]/div/div[2]/div/ul/li[1]/div/div/div/div[1]/div/div[4]/a")));
		...
		String utmParamsUrl = currentUrl
				+ "?utm_source=google&utm_medium=search&utm_campaign=GS_ENG-Speaking_NB_Email_TCPA&utm_term=sms";
